...
DEFINE_GRADIENT_PALETTE( Primary_01_gp ) {
  0,  16, 82, 255,
  63,  91, 156, 103,
  127, 255, 255, 25,
  191, 255, 75, 18,
...
DEFINE_GRADIENT_PALETTE( Tertiary_01b_gp ) {
  0,   0,  1, 80,
  63,  20,  1, 34,
  127, 120,  1,  2,
  191, 177, 66,  1,
...
DEFINE_GRADIENT_PALETTE( occ092_gp ) {
  0, 179, 33,  5,
  127, 242, 56, 31,
  255, 255, 191, 127
};
...
void setup() {
 ...
 // LEDS.addLeds<WS2812B, DATA_PIN, GRB>(leds, NUM_LEDS);
  LEDS.addLeds<APA102, DATA_PIN, CLOCK_PIN, BGR>(leds, NUM_LEDS);//.setCorrection( TypicalSMD5050 );
...
void loop() {
  ...
  for (int lea = 0 ; lea < LEAFS ; lea++) {
    ...
    leds[lea * LEDPLEAF + a] = nblend(leds[lea * LEDPLEAF + a],  color[lea], 3);
